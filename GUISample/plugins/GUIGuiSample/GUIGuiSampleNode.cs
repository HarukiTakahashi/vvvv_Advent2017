...
{
	#region PluginInfo
	[PluginInfo(Name = "GuiSample", Category = "GUI", Help = "Template with some gui elements", Tags = "", AutoEvaluate = true)]
	#endregion PluginInfo
	public class GUIGuiSampleNode : UserControl, IPluginEvaluate
	{
		#region fields & pins
